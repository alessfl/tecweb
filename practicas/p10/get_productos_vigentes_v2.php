        ...
        <table class="table">
            <thead class="thead-dark">
                <tr>
                    ...
                    <th scope="col">Editar</th> <!-- Nueva columna -->
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td><img src="<?= htmlspecialchars($row['imagen']) ?>" width="80"/></td>
                    <td><button class="btn btn-primary btn-sm" onclick="editarProducto(<?= $row['id'] ?>)">Editar</button></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
